package com.example.chatapplication.bottombar
...
@Composable
fun BottomNavigationItem(icon: () -> Unit?, label: @Composable () -> Unit?, selected: Boolean, selectedContentColor: Color, unselectedContentColor: Color, modifier: Modifier, onClick: () -> Unit?) {
